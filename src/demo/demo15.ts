...
export const init = async (canvas: HTMLCanvasElement) => {
  ...
  const initMartix = straightPerspective1(60 * Math.PI / 180, canvas.width / canvas.height, 1, 2000)
  // const initMartix = projection(canvas.width, canvas.height, 800)
  watchEffect(() => {
    ...
    console.log(initMartix)
    console.log(positionTransform([0,0,2000], initMartix))
