...
import { rotateY as angleY, rotateX as angleX, rotateZ as angleZ, scaleX, scaleY, scaleZ, moveX, moveY, moveZ } from "../status";
...
export const init = (canvas: HTMLCanvasElement) => {
  ...
  watch([angleY, angleX, angleZ, scaleX, scaleY, scaleZ, moveX, moveY, moveZ], () => redraw())
